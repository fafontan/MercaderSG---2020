...
namespace Negocios
{
    public class UsuarioRN
    {
        ...
        public static void AltaUsuario(UsuarioEN Usuario)
        {
            ...
            {
                throw new WarningException(Negocios.My.Resources.ArchivoIdioma.UsuarioExistente);
                return;
            }
            else
            {
        ...
        public static void CambiarContraseña(string UsuarioLogueado, string ContraseñaAnterior, string NuevaContraseña)
        {
            ...
            if (UsuarioAD.ValidarContraseña(UsuEnc, ConAntEnc) > 0)
            {
                ...
                DVVDatosBitacora.TipoAccion = "Alta";
                Integridad.GrabarDVV(DVVDatosBitacora);
                throw new InformationException(Negocios.My.Resources.ArchivoIdioma.ContraseñaCambiada);
            }
            else
            {
                throw new WarningException(Negocios.My.Resources.ArchivoIdioma.ContraseñaInvalida);
            }
        }
        ...
        public static void DesbloquearUsuario(string Usuario)
        {
            ...
            DVVDatosBitacora.TipoAccion = "Alta";
            Integridad.GrabarDVV(DVVDatosBitacora);
            throw new InformationException(Negocios.My.Resources.ArchivoIdioma.DesbloquearUsuario);
        }
        ...
        public static bool Logueo(UsuarioEN Usuario)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    DVVDatos.ValorDVHAntiguo = ValorDVHAntiguo;
                    Integridad.GrabarDVV(DVVDatos);
                    throw new WarningException(Negocios.My.Resources.ArchivoIdioma.UsuarioRevision);
                }
            }
        }
        ...
        public static void ModificarUsuario(UsuarioEN Usuario)
        {
            ...
            DVVDatosBitacora.TipoAccion = "Alta";
            Integridad.GrabarDVV(DVVDatosBitacora);
            throw new InformationException(Negocios.My.Resources.ArchivoIdioma.ModificarUsuario);
        }
